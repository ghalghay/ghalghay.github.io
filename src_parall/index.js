    ...
    },
    {
        ...
        calculateCellValue: function(rowData){
           if(rowData.e){
             ...
             text = text.replace(/(ПуМоцИСаль)/g, "Пушкин А. С. «Моцарт и Сальери» // «Моцарти Сальерии» \(Пер. С. И. Чахкиева\)");
             text = text.replace(/(КиплРикк)/g, "Киплинг Р. «Рикки-Тикки-Тави» \(Пер. Т. И. Мальсагова\)");
             text = text.replace(/(КапДочк)/g, "Пушкин А. С. «Капитанская дочка» // «Капитана йоI» \(Пер. Х. Осмиева\)");
             return text;
           }
        },
